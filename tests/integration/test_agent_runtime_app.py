...
async def test_agent_stream_query(agent_app: AgentEngineApp) -> None:
    ...
    message = '{"amount": 45.50, "submitter": "bob@company.com", "category": "meals", "description": "Client lunch", "date": "2026-06-20"}'
    events = []
    ...
    for event in events:
        ...
        if validated_event.output or validated_event.content:
            has_text_content = True
            break

    assert has_text_content, "Expected at least one event with content or output"
